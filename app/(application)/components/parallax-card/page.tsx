  ...
  return (
    <div className="relative space-y-4">
      ...
      <div className="border-b border-[var(--base-300)] pb-6">
        <h1 className="text-3xl font-bold text-[var(--base-content)]">Parallax Card</h1>
        <p className="text-[var(--base-content)]/70 mt-2">
          Interactive 3D card component with parallax effects that responds to mouse movement. Features multiple visual variants and full customization options.
        </p>
      </div>
